...
import { submitData, validate } from "../scripts/validationFormSubmit";
    ...
    return (
        <section className="form-container">
            <div className="container">
                {submitted ? (
                    <div
                        className="alert alert-success text-center mb-5"
                        role="alert"
                    >
                ...
                {failedSubmit ? (
                    <div
                        className="alert alert-danger text-center mb-5"
                        role="alert"
                    >
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div>
                        ...
                        <input
                            className={errors.name ? "errorFrame" : ""}
                            id="name"
                            type="text"
                            name="name"
                    ...
                    <div>
                        ...
                        <input
                            className={errors.email ? "errorFrame" : ""}
                            id="email"
                            type="email"
                            name="email"
                    ...
                    <div className="comment">
                        <label id="comment-label" htmlFor="comment">
                            Comment
                        </label>
                        <textarea
                            className={errors.comments ? "errorFrame" : ""}
                            id="comments"
                            name="comment"
                    ...
                    <div className="submitbutton">
                        <button type="submit" className="button bg-red">
                            Post Comments
                        </button>
                    </div>
                </form>
