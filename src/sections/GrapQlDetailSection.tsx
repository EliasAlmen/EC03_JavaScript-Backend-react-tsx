...
const GraphQLDetailSection: React.FC = () => {
    ...
    const ratingNumber = parseInt(data.productGraphQL.rating)
                    ...
                    <div className="image-shop">
                        <div className="images">
                            <div className="big-image">
                                <img src={data.productGraphQL.imageName} alt={data.productGraphQL.name}></img>
                            </div>
                        ...
                        <div className="shop">
                            <h1>{data.productGraphQL.name}</h1>
                            <p>
                                SKU:{`\u00a0\u00a0`}
                                {data.productGraphQL._id}
                            </p>
                            <p>
                                CATEGORY:{`\u00a0\u00a0`}
                                {data.productGraphQL.category}
                            </p>
                            {Array(ratingNumber)
                                .fill(0)
                                .map((_, i) => (
                            ...
                            <p className="price">${data.productGraphQL.price}.00</p>
                            <p className="description">
                                {data.productGraphQL.description}. Discovered had get considered
...
export default GraphQLDetailSection