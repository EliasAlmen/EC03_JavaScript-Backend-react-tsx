...
const HomeView = () => {
  ...
  const [featuredProducts, setFeaturedProducts] = useState([
    ...
    { id: 5, offPriceOnItemValue: true, offPrice: "$10.00", price: "$20.00", productName: "New look men's sneakers", category: "Casual", rating: 5, img: "https://via.placeholder.com/208x256"},
    ...
    { id: 7, offPriceOnItemValue: false, price: "$350.00", productName: "Men's denim shirts full", category: "Casual", rating: 5, img: "https://via.placeholder.com/208x256"},
    { id: 8, offPriceOnItemValue: false, price: "$50.00", productName: "Women's leather bag", category: "Casual", rating: 5, img: "https://via.placeholder.com/208x256"}
  ])
