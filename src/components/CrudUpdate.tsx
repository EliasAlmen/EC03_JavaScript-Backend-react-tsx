...
const CrudUpdate = () => {
    ...
    const { crudProduct, setCrudProduct, get, update  } = React.useContext(CrudProductContext) as ICrudProductContext;
    ...
    return (
        <form onSubmit={update} className="create form-group">
            ...
            <input value={crudProduct.price} onChange={(e) => setCrudProduct({ ...crudProduct, price: parseInt(e.target.value) })} type="text" name='price' className='form-control' placeholder='Price...' />
            <input value={crudProduct.rating} onChange={(e) => setCrudProduct({ ...crudProduct, rating: parseInt(e.target.value) })} type="text" name='rating' className='form-control' placeholder='Choose a rating...' />
